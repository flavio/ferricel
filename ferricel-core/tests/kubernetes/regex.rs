...
fn test_k8s_regex_find_all_multiple_matches() {
    let result = compile_and_execute_json(r#""123 abc 456".findAll("[0-9]+")"#)
        .expect("compile/execute failed");
    assert_eq!(
        result,
...
fn test_k8s_regex_find_all_no_matches() {
    let result =
        compile_and_execute_json(r#""abc def".findAll("[0-9]+")"#).expect("compile/execute failed");
    assert_eq!(
        result,
        serde_json::json!([]),
...
fn test_k8s_regex_find_all_single_match() {
    let result = compile_and_execute_json(r#""only 1 number".findAll("[0-9]+")"#)
        .expect("compile/execute failed");
...
fn test_k8s_regex_find_all_empty_string() {
    let result =
        compile_and_execute_json(r#""".findAll("[0-9]+")"#).expect("compile/execute failed");
...
fn test_k8s_regex_find_all_n_limit_one() {
    let result = compile_and_execute_json(r#""123 abc 456 def 789".findAll("[0-9]+", 1)"#)
        .expect("compile/execute failed");
...
fn test_k8s_regex_find_all_n_limit_two() {
    let result = compile_and_execute_json(r#""123 abc 456 def 789".findAll("[0-9]+", 2)"#)
        .expect("compile/execute failed");
...
fn test_k8s_regex_find_all_n_limit_exceeds_matches() {
    let result = compile_and_execute_json(r#""123 abc 456".findAll("[0-9]+", 10)"#)
        .expect("compile/execute failed");
    assert_eq!(result, serde_json::json!(["123", "456"]));
}
...
fn test_k8s_regex_find_all_n_limit_zero() {
    let result = compile_and_execute_json(r#""123 abc 456".findAll("[0-9]+", 0)"#)
        .expect("compile/execute failed");
    assert_eq!(result, serde_json::json!([]));
}
